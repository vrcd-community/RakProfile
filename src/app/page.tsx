...
const AppCard = ({ title, description, icon: Icon, color, link }: any) => {
  return (
    <Link href={link} className={`rounded-xl overflow-hidden flex flex-row justify-between shadow hover:shadow-xl group`} style={{ borderColor: color, borderWidth: "2px", backgroundColor: color }}>
